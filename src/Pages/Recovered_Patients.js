...
export function Recovered_Patients() {
  ...
  useEffect(() => {
    if (patientlist) {
      let recoveredpatientlist = patientlist.filter(
        (e) => e.diagnosticStatus.patientFlow == "yes"
      );
      if (recoveredpatientlist) {
        setRows(recoveredpatientlist);
        setSearchApiData(recoveredpatientlist);
        console.log("recoveredpatientlist", recoveredpatientlist);
      }
    }
  }, [patientlist]);
