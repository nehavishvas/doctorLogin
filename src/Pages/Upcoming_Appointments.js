...
export function Upcoming_Appointments() {
  ...
  useEffect(() => {
    if (confirmedpatientlist) {
      ...
      const futureAppointments = confirmedpatientlist.filter((patient) => {
        const appointmentDate = new Date(patient.appointment_date);
        return appointmentDate > today;
      });

      setRows(futureAppointments);
      setSearchApiData(futureAppointments);
    }
