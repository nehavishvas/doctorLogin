...
export function X_Ray_Patient_List() {
  ...
  const { patientlist, patientrecord } = useContext(AppContext);
  ...
  useEffect(() => {
    if (patientlist) {
      let xRayPatients = patientlist.filter(
        (e) => e.xRayReportUploaded === "yes"
      );
          ...
          <Table stickyHeader aria-label="sticky table">
            ...
            <TableBody>
              {rows
                ...
                .map((row, i) => {
                  return row.xRay.map((xRayReport, index) => (
                    <TableRow
                      hover
                      role="checkbox"
                      tabIndex={-1}
                    ...
                    >
                      {index === 0 && (
                        <>
                          <TableCell align="left" rowSpan={row.xRay.length}>
                          ...
                          <TableCell align="left">
                            {moment(xRayReport.xRayDate).format("MMMM D, YYYY")}
                          </TableCell>
                          <TableCell align="center" rowSpan={row.xRay.length}>
                            {row.appointmentNo ? row.appointmentNo : "_"}
                          </TableCell>
                          <TableCell align="left">
                            <IconButton
                              onClick={() => openPDF(xRayReport.xRayReport)}
                              style={{
