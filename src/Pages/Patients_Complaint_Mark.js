...
export function Patients_Complaint_Mark() {
  ...
  useEffect(() => {
    if (patientlist) {
      ...
      console.log("complaintlist mark  ", sortedPatientListByDate);
  ...
  const complaintform = (no, date) => {
    console.log(`${no}`);
    passdatatocomplaintform(no, date);
    let obj = { no: no, date: date };
    localStorage.setItem("passdatacomplaintform", JSON.stringify(obj));
    navigate("./Patients_Complaint_Form");
  };
  return (
    <div>
                    ...
                    >
                      ...
                      <TableCell align="center">
                        {!(row.complaint == "") ? (
                          ...
                          <NavLink to={"Patients_Complaint_Form"}>
                            <button
                              type="button"
                              class="btn btn-primary"
