...
export function X_Ray_Patients_Form() {
  ...
  useEffect(() => {
    if (patientlist) {
      ...
      console.log("this is lab list form", lablist);
    }
  }, [patientlist]);
  ...
  const labform = (id, no) => {
    ...
    localStorage.setItem("xrayformpassdata", JSON.stringify(obj));
  };
  return (
    <div>
